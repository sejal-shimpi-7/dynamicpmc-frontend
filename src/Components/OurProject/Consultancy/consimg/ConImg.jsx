  ...
  return (
    ...
    >
      <div className="image-container">
        <img src={img.imageUrl.startsWith('http') ? img.imageUrl : `http://localhost:3344${img.imageUrl}`} alt={img.description || `Consultancy ${index + 1}`} />
      </div>
...
const ConImg = ({ images = [] }) => {
  return (
    <div className="consultancy-gallery">
